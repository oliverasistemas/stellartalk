...
func (k Keeper) MyReceivedChats(goCtx context.Context, req *types.QueryMyReceivedChatsRequest) (*types.QueryMyReceivedChatsResponse, error) {
	if req == nil {
	...
	return &types.QueryMyReceivedChatsResponse{Chat: chats, Pagination: pageRes}, nil
}
