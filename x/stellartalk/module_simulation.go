...
import (
	...
	stellartalksimulation "stellartalk/x/stellartalk/simulation"
...
var (
	_ = sample.AccAddress
	_ = stellartalksimulation.FindAccount
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	stellartalkGenesis := types.GenesisState{
		Params: types.DefaultParams(),
		// this line is used by starport scaffolding # simapp/module/genesisState
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&stellartalkGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgCreateChat,
		stellartalksimulation.SimulateMsgCreateChat(am.accountKeeper, am.bankKeeper, am.keeper),
	))
